...
namespace Thetis
{
    public static class LogTool
    {
        ...
        // Yurij-eu2av - 2026-07-03: Per-Monitor DPI awareness toggle.
        // Stored in the registry (NOT database.xml) because it must be read very
        // early in Main(), before the DB is initialised and before any window is
        // created. Default is OFF (zero behavioural change).
        ...
        // Yurij-eu2av - 2026-07-03: DPI awareness registry helpers.
        static bool readRegistryDpiAwareness()
        {
            ...
            return enabled; // default OFF when missing/error
        }
